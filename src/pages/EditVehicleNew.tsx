...
const EditVehicleNew = () => {
  ...
  // Navigate after update is completed
  useEffect(() => {
        ...
        updateVehicle(
          { id, data: formData },
          {
            onSuccess: async () => {
              ...
              try {
                // Force refresh from server before navigating
                await refetch();
  ...
  // Handle status update with verification
  ...
  console.log(`Rendering vehicle with validated status: ${validatedStatus}`);
