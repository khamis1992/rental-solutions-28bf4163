    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="container relative flex flex-col items-center justify-center min-h-screen py-12 space-y-12 z-20">
        ...
        <div className="absolute top-4 right-4 z-30">
          <LanguageSwitcher position="inline" variant="outline" />
        </div>
        ...
        >
          <motion.h1 
            className="text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-400 lg:text-6xl" 
            initial={{ opacity: 0 }} 
            animate={{ opacity: 1 }} 
          ...
          <motion.p 
            className="max-w-[600px] text-muted-foreground text-xl mx-auto" 
            initial={{ opacity: 0 }} 
            animate={{ opacity: 1 }} 
        ...
        >
          {/* First feature card */}
          <motion.div 
            className="flex flex-col p-6 bg-card/80 backdrop-blur-sm rounded-lg shadow-lg border border-border/50 transition-all duration-300 hover:shadow-xl hover:scale-105" 
            whileHover={{ y: -5 }}
          >
