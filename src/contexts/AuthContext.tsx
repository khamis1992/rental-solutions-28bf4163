...
export const useSafeAuth = (): AuthContextType => {
  ...
  if (context === null) {
    ...
    console.warn('useSafeAuth called outside AuthProvider, using fallback values');
    return {
      user: null,
      session: null,
      loading: true,
      signIn: async () => { console.warn('signIn called outside AuthProvider'); },
      signUp: async () => { console.warn('signUp called outside AuthProvider'); },
      signOut: async () => { console.warn('signOut called outside AuthProvider'); },
      resetPassword: async () => { console.warn('resetPassword called outside AuthProvider'); },
      updateUserData: async () => { console.warn('updateUserData called outside AuthProvider'); },
    };
  }
