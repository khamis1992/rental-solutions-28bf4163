            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  معالجة العقد بالذكاء الاصطناعي
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {!isProcessing ? (
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-lg">جاهز لمعالجة العقد باستخدام ChatGPT</p>
                  ...
                  <div className="space-y-4">
                    <div className="text-center">
                      ...
                      <p className="font-semibold">جاري المعالجة بـ ChatGPT...</p>
                    </div>
