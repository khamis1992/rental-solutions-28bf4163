...
export function EditAgreementContent({
  ...
  const agreementForForm: Agreement = {
    ...agreement,
    start_date: typeof agreement.start_date === 'string' ? agreement.start_date : (agreement.start_date as Date)?.toISOString() || '',
    end_date: typeof agreement.end_date === 'string' ? agreement.end_date : (agreement.end_date as Date)?.toISOString() || '',
    created_at: typeof agreement.created_at === 'string' ? agreement.created_at : (agreement.created_at as Date)?.toISOString() || '',
    updated_at: typeof agreement.updated_at === 'string' ? agreement.updated_at : (agreement.updated_at as Date)?.toISOString() || '',
