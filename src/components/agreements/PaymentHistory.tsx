...
export function PaymentHistory({
  ...
  } = usePayments(agreementId, rentAmount);
  ...
  if (!agreementId) {
    return (
      <Alert>
        ...
        <AlertDescription>No agreement ID provided.</AlertDescription>
      </Alert>
    );
  }

  return (
    <ErrorBoundary fallback={<div className="p-4 text-red-500">Error loading payment history</div>}>
      <Card>
