...
const VehicleCard = ({
  ...
  // Use fallback static images when needed
  ...
  try {
    ...
    // If we have a Supabase image URL from storage, use it first
    if (imageUrl && imageUrl.includes('storage.googleapis.com') || imageUrl?.includes('supabase.co')) {
      displayImageUrl = imageUrl;
      console.log('Using Supabase storage image:', imageUrl);
    }
    // Otherwise fall back to our model-specific static images
