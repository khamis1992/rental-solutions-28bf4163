...
export const TrafficFineValidationHistory: React.FC = () => {
  const { validationHistory, isLoadingHistory, historyError, refetchHistory } = useTrafficFinesValidation();
      ...
      <CardContent>
        {isLoadingHistory ? (
          ...
          <div className="p-4 border border-red-200 rounded-md bg-red-50 text-red-800">
            ...
            <p className="text-sm">{historyError instanceof Error 
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      {item.result.hasFine && item.result.fineDetails ? (
                        <span>
                          {formatCurrency(item.result.fineDetails.amount || 0)} - 
