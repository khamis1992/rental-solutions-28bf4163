...
export const BREAKPOINTS = {
  MOBILE: // 640 - removed unused variable// sm
  TABLET: // 768 - removed unused variable// md
  LAPTOP: // 1024 - removed unused variable// lg
  DESKTOP: // 1280 - removed unused variable// xl
};
