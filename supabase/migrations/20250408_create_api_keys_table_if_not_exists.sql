...
-- This migration creates the API keys table if it doesn't exist
-- Note: The main API keys tables were created in 20250409_create_api_keys_table.sql
-- This is a safety migration to ensure the table exists
...
BEGIN
    IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'api_keys') THEN
        ...
        -- Create API usage logging table if it doesn't exist
