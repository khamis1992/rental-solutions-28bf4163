...
نظام شامل لإدارة تأجير السيارات مصمم خصيصاً للسوق القطري مع دعم كامل للغة العربية و RTL.

## 🌟 المميزات الرئيسية

### 🏢 إدارة العملاء
- إضافة وتعديل بيانات العملاء
- مسح البطاقات الشخصية باستخدام Google Vision
- تتبع السجلات المالية والدفعات
- نظام تصنيف العملاء

### 🚙 إدارة المركبات
- إضافة وتعديل المركبات
- تتبع حالة المركبة (متاحة، مؤجرة، صيانة)
- إدارة الصيانة والإصلاحات
- نظام تتبع الأميال والاستهلاك

### 📄 إدارة العقود
- إنشاء عقود إيجار تلقائية
- نظام دفعات أوتوماتيكي
- تتبع المدفوعات والمتأخرات
- إنشاء ملفات PDF للعقود
...
# مخرجات البناء تذهب إلى مجلد dist/
ls -la dist/
```
...
```
dist/
├── assets/          # ملفات JavaScript و CSS المحسّنة
├── icons/           # أيقونات PWA لجميع الأجهزة
...
### تثبيت التطبيق
⚠️ **هذا تطبيق PWA وليس APK أندرويد**
- المستخدمون يثبتون التطبيق عبر المتصفح
- "إضافة إلى الشاشة الرئيسية" في أندرويد
- يعمل مثل التطبيق الأصلي بعد التثبيت
- لا يحتاج متجر التطبيقات

للمزيد من التفاصيل، راجع [BUILD_OUTPUT_GUIDE.md](./BUILD_OUTPUT_GUIDE.md)
